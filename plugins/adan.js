...
const renek = "```Not found the city!```"
        ...
        Cutie.addCommand({pattern: 'prayer ?(.*)', desc: adzan, usage: usage, fromMe: false}, async (message, match) => {
	    ...
	    try {
		    ...
		    if (response.statusCode === 200) return await message.client.sendMessage(message.jid,  '*QueenCutie*:\n' +
